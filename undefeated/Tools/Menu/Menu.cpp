...
void SetupMenu()
{
	...
	AddNewMenuBox( "Other", 450, 20, 235, 220, Tab_Ragebot );
	{
		...
		AddNewButton(Tab_Ragebot, Ragebot_Resolver, false, 470, 40, "Resolver");
	}
	...
	/* MISC */
	{
		AddNewMenuBox( "Miscellaneous", 195, 20, 235, 455, Tab_Misc );
		{
			...
			std::vector< char* > ClanTag = { "solitude", "solitude", "UNDEFEATED" };
			...
			AddNewDropbox( 235, 135, Tab_Misc, Misc_FakeLag, "Fake Lag", 7, Fakelag );
			...
			AddNewButton( Tab_Misc, Misc_Aimstep, false, 215, 225, "Aim Step" );
			AddNewButton( Tab_Misc, Misc_ClanTagSpammer, false, 215, 245, "Clantag" );
			AddNewDropbox( 235, 260, Tab_Misc, Misc_ClanTagSelection, "", 3, ClanTag );
			AddNewButton( Tab_Misc, Misc_ClanTagAnimate, false, 235, 290, "Animate Clantag" );
		...
		{
			//Dropbox Config
			std::vector< char* > wgroup = { "Current", "Rifle", "Pistol", "Auto", "Awp", "Scout", "Shotgun", "SMG", "Heavy", "Current" };
	...
	AddNewFuncButton( 195, 185, ( DWORD )Unhook, "Unload", Tab_Config );
}
